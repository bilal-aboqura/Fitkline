...
import { getActiveProductVariants, type Product } from "@/data/products";
...
export function ProductDirectory({
  ...
  return (
    <section
      className="product-directory product-directory--redesign"
    ...
    >
      <div className="fit-container">
            ...
            >
              <div className="product-card__visual">
                ...
                <Image
                  ...
                  width={560}
                  height={720}
                  sizes="(max-width: 720px) 90vw, (max-width: 1100px) 44vw, 31vw"
                />
              </div>
              ...
              <div className="product-card__body">
                <div className="product-card__heading">
                  ...
                  <span className="product-card__action" dir="ltr">
                    {size.label}
                  </span>
                </div>
        ...
        <div className="product-directory__base-line">
          ...
          <Link href="/products">
            استكشف كل العبوات <span aria-hidden="true">←</span>
          </Link>
        </div>
      </div>
    </section>
